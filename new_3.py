...
def     apply_svm(y_train, y_val, key, training_data, validation_data):
    ...
    write_results([rbf_dict, sigmoid_dict, polynomial_dict, linear_dict], [f"rbf_{key}", f'sigmoid_{key}', f'polynomial_{key}', f'linear_{key}'], 'resultsSVMWithGamma/')
...
if __name__ == "__main__":
    ...
    apply_model_wordEmbedding(y_train, y_val, 'glove', X_train_vector, X_val_vector)
    ...
    # apply_svm(y_train, y_val, 'glove_svm', X_train_vector, X_val_vector)
    ...
    write_results(accuracy_dict_list, accuracy_dict_list_names, "results_final/")